...
| Phase 4: Document drafting | Write all 9 sections of the practitioner guide | In progress (sections 1, 2, 3, 5, 6, and 8 drafted; sections 4, 7, 9 not started) |
| Phase 5: Regulatory crosswalk | Surface the regulatory mapping as a primary artifact | Partial (regulatory landscape narrative drafted in section 3; regulatory facts reference file at `docs/frameworks/regulatory-facts.md`; common-control crosswalk in section 4 not yet drafted) |
...
| Document drafting | Sections 1, 2, 3, 5, 6, and 8 drafted; sections 4, 7, 9 not started |
...
|---|---|---|
| A. Draft practitioner guide sections 4 (Common-control crosswalk), 7 (Implementation considerations), 9 (References) | Remaining unwritten sections of the practitioner guide | Recommended next: sections 1, 2, 3, 5, 6, and 8 are drafted; closing the remaining three sections gives a complete v1 document. Section 4 is the natural successor to section 3 because the regulatory landscape narrative already names the common-control convergence point. |
