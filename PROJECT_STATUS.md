...
| Phase 3: Control library | Frame v1 library, draft entries | In progress (3 of 5 fully populated, 2 stubs) |
...
| 6. Recommended controls | Partially populated (CTL-001, CTL-002, and CTL-003 inserted; CTL-004 and CTL-005 forthcoming) |
...
| `data/controls.json` | CTL-001, CTL-002, and CTL-003 populated; CTL-004 and CTL-005 as stubs |
...
| Element | Status |
|---|---|
| Foundation | Solid: framework documents done, 2 threats fully populated, 8 threats committed as compressed drafts, 3 controls fully populated |
...
| Control library completeness | 3 of 5 fully populated, 2 stubs |
