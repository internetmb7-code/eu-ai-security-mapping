...
| Phase 3: Control library | Frame v1 library, draft entries | In progress (4 of 5 fully populated, 1 stub) |
...
| 6. Recommended controls | Partially populated (CTL-001, CTL-002, CTL-003, and CTL-004 inserted; CTL-005 forthcoming) |
...
| `data/controls.json` | CTL-001, CTL-002, CTL-003, and CTL-004 populated; CTL-005 as stub |
...
| Element | Status |
|---|---|
| Foundation | Solid: framework documents done, 2 threats fully populated, 8 threats committed as compressed drafts, 4 controls fully populated |
...
| Control library completeness | 4 of 5 fully populated, 1 stub |
